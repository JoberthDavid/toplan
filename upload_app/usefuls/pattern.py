...
FIXED_TIME_PATTERN = r'(t)(\s{1,2})(?P<FIXEDMATQUANTREGEX>\d{1,3}(\.\d{3})*,\d{5})(\s{1,2})(\d{1,3}(\.\d{3})*,\d{4})(\s{1,2})(\d{1,3}(\.\d{3})*,\d{4})(\s{1,2})(?P<FIXEDCODEREGEX>\d{7})(\s{1,2})(?P<FIXEDMATCODEREGEX>[M]\d{4}|\d{7}) (.+)'
...
ACTIVITIES_PATTERN_ALFA = r'(\d{1,3}(\.\d{3})*,\d{4}) (\d{1,3}(\.\d{3})*,\d{4}) (.+) (?P<ACTIQUANTREGEX>\d{1,3}(\.\d{3})*,\d{5}) (.+)'
ACTIVITIES_PATTERN_BETA = r'(.+) (?P<ACTIVITIESCODEREGEX>\d{7})'
