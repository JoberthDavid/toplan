...
EQUIPEMENT_PATTERN_BETA = r'(.+)(\s{0,1})(?P<EQUIPCODEREGEXBETA>[EA]\d{4})'
...
FIXED_TIME_PATTERN = r'(?P<FIXEDUNITREGEX>t\s{1,2})(?P<FIXEDMATQUANTREGEX>\d{1,3}(\.\d{3})*,\d{5})(\s{1,2})(\d{1,3}(\.\d{3})*,\d{4})(\s{1,2})(\d{1,3}(\.\d{3})*,\d{4})(\s{1,2})(?P<FIXEDCODEREGEX>\d{7})(\s{1,2})(?P<FIXEDMATCODEREGEX>[M]\d{4}|\d{7}) (.+)'
TRANSPORTATION_PATTERN = r'(.+)(\s{0,2})(?P<TRANSPMATQUANTREGEX>\d{1,3}(\.\d{3})*,\d{5})(\s{0,2})(?P<TRANSPUNITREGEX>tkm)(\s{0,2})(?P<TRANSPRPCODEREGEX>\d{7})(\s{1,2})(?P<TRANSPLNCODEREGEX>\d{7})(\s{1,2})(?P<TRANSPPVCODEREGEX>\d{7})(\s{1,2})(?P<TRANSPMATCODEREGEX>[M]\d{4}|\d{7})$'
ACTIVITIES_PATTERN = r'(\d{1,3}(\.\d{3})*,\d{4})(\s{1,2})(\d{1,3}(\.\d{3})*,\d{4})(\s{0,2})(.+)(\s{0,2})(?P<ACTIQUANTREGEX>\d{1,3}(\.\d{3})*,\d{5})(\s{1,2})(.+)(\s{0,2})(?P<ACTIVITIESCODEREGEX>\d{7})$'
