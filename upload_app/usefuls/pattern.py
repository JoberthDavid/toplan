...
EQUIPAMENT_CODE_REGEX = 'EQUIPCODEREGEX'
EQUIPAMENT_QUANT_REGEX = 'EQUIPQUANTREGEX'
EQUIPAMENT_UTIL_REGEX = 'EQUIPUTILREGEX'
WORKMANSHIP_CODE_REGEX = 'WORKMANSHIPCODEREGEX'
WORKMANSHIP_QUANT_REGEX = 'WORKMANSHIPQUANTEREGEX'
WORKMANSHIP_BREAK_REGEX = 'WORKMANSHIPBREAKREGEX'
...
EQUIPAMENT_PATTERN = r'(\d{1,3}(\.\d{3})*,\d{4}) (\d{1,3}(\.\d{3})*,\d{4}) (\d{1,3}(\.\d{3})*,\d{4}) (\d+\,\d{2}) (?P<EQUIPUTILREGEX>\d+\,\d{2}) (?P<EQUIPQUANTREGEX>\d+\,\d{5}) (.+) (?P<EQUIPCODEREGEX>[EA]\d{4})'
WORKMANSHIP_PATTERN = r'(\d{1,3}(\.\d{3})*,\d{4}) (\d{1,3}(\.\d{3})*,\d{4}) (h|mês) (?P<WORKMANSHIPQUANTEREGEX>\d+\,\d{5}) (\w+) (?P<WORKMANSHIPCODEREGEX>[P]\d{4})'
WORKMANSHIP_BREAK_PATTERN = r'(?P<WORKMANSHIPBREAKREGEX>Custo horário total de mão de obra) (\d{1,3}(\.\d{3})*,\d{4})'
